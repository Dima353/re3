...
#ifndef PSP2	// World Lightmaps need Xbox neo resources (absent in PC data) - hide on Vita
...
// "reVC.ini" never opens here and settings would not persist.
mINI::INIFile ini(PSP2_DATA_PATH "/reVC.ini");
#else
